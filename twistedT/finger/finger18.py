...
# create at         : 2018-06-12 19:34
# last modify       : 2018-06-12 19:34
# ----------------------------------------------
...
fingerEndpoint.listen(f.getFingerFactory()) 

endpoint2 = endpoints.serverFromString(reactor, "tcp:8081")
endpoint2.listen(server.Site(f.getResource()))
